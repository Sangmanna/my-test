...
public class ShopifyLineItemDiscount implements Serializable {
	...
	private ShopifyPrice amountSet;
	...
	public ShopifyPrice getAmountSet() {
		return amountSet;
	}

	public void setAmountSet(ShopifyPrice amountSet) {
