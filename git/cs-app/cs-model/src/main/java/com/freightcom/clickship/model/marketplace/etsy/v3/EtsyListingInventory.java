...
public class EtsyListingInventory implements Serializable {

	private static final long serialVersionUID = 3206674016367564633L;

	@JsonProperty("products")
    private List<EtsyVariantProduct> products;
    ...
    public List<EtsyVariantProduct> getProducts() {
        return products;
    }

    public void setProducts(List<EtsyVariantProduct> products) {
