...
@XmlRootElement(name = "PackageDimensions", namespace="http://mws.amazonservices.com/schema/Products/2011-10-01/default.xsd")
...
public class PackageDimensions implements Serializable {
	...
	public PackageDimensions(Height height, Length length, Width width, Weight weight) {
		super();
		this.height = height;
		this.length = length;
		this.width = width;
