...
public class RegisterCustomerResponse_ extends Freightcom implements Serializable {
	...
	@XmlElement(name= "RegisterCustomerRequestReply")
	...
	public void setResponse(RegisterCustomerResponse response) {
