...
public class ReebeloFulfillment implements Serializable {
	...
	public ReebeloTrackingInfo getTrackingInfo() {
		return trackingInfo;
	}

	public void setTrackingInfo(ReebeloTrackingInfo trackingInfo) {
	...
	public List<ReebeloOrderLineItem> getLineItmes() {
		return lineItmes;
	}

	public void setLineItmes(List<ReebeloOrderLineItem> lineItmes) {
		this.lineItmes = lineItmes;
	}

	@Override
	public String toString() {
		return "ReebeloFulfillment [id=" + id + ", name=" + name + ", orderId=" + orderId + ", status=" + status
