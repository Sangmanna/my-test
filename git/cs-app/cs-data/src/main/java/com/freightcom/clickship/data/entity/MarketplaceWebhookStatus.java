...
@Entity
@Table(name = "marketplace_webhook_status")
public class MarketplaceWebhookStatus extends BaseEntity {
	...
	public MarketplaceWebhookStatus() {
		super();
	}
	
	public MarketplaceWebhookStatus(String customer, String businessName, String marketplace, String url) {
		super();
		this.storeUrl = url;
	...
	@Override
	public MarketplaceWebhookStatus setId(String id) {
		this.id = id;
		return this;
	}
